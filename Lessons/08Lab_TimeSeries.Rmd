...
rainfall_ts <- ts(Rainfall_BR_processed$Rainfall, start = c(1901,1), end = c(2016,12),frequency = 12)
temp_ts <- ts(Temp_BR_processed$Temperature_C,start = c(1901,1),end = c(2016,12), frequency = 12)
