...
NTL.phys.data.Tuesday <-  filter(NTL.phys.data, lakename == c("Tuesday Lake"))
NTL.phys.data.Tuesday.9099 <- filter(NTL.phys.data.Tuesday, year4 %in% c(1990:1999))
...
summary(NTL.phys.data.processed$temperature_C)
