...
everything in the vector has to be the same datatype
...
temps_diff <- c(temps_F - mean (temps_F))
...
#Add a new column to the dataframe (it has to be vector of the same length, if no value say NA)
